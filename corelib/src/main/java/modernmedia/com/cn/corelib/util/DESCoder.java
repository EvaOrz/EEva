...
public class DESCoder {
    ...
    public final static String DESKEY = "icebolt1";
    ...
    public static String encode(String plainText) throws Exception {
        ...
        byte[] crypted = null;
        try {
            SecretKeySpec skey = new SecretKeySpec(DESKEY.getBytes(), "DES");
