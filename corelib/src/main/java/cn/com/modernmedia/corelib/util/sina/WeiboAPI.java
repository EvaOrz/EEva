...
import cn.com.modernmedia.corelib.util.sina.net.AsyncWeiboRunner;
import cn.com.modernmedia.corelib.util.sina.net.RequestListener;
...
public abstract class WeiboAPI {
    ...
    protected void request(final String url, final WeiboParameters params, final String
            httpMethod, RequestListener listener) {
