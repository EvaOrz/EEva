...
package cn.com.modernmedia.corelib.widget.views;
...
import cn.com.modernmedia.corelib.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    //    private static final int[] SHADOWS_COLORS = new int[]{R.color.wheel_1, R.color.wheel_2, R.color.wheel_3};
    ...
    private void initResourcesIfNecessary() {
        int[] SHADOWS_COLORS = new int[]{getContext().getResources().getColor(R.color.wheel_1), getContext().getResources().getColor(R.color.wheel_2), getContext().getResources().getColor(R.color.wheel_3)};
