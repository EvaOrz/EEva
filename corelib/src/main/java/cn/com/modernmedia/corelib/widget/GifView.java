package cn.com.modernmedia.corelib.widget;
...
public class GifView extends View {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.GifMoviewView, defStyle, R.style.Widget_GifView);
