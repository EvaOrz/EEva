...
public class HandleEventApi extends BaseApi {
     ...
     * @param type
     */
    public HandleEventApi(Context c, int type, String id, String img, String time) {
        this.type = type;
    ...
    protected void handler(JSONObject jsonObject) {
        ...
        Log.e("HandleEventApi", jsonObject.toString());
