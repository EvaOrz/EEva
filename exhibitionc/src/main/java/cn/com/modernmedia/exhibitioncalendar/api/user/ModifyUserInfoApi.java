...
public class ModifyUserInfoApi extends BaseApi {
     ...
     * @param desc
     */
    public ModifyUserInfoApi(Context context, String uid, String token, String realName, String userName, String nickName, String url, String password, String desc, boolean pushEmail) {
        super();
