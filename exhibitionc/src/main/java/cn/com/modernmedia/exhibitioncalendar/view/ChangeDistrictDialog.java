...
import cn.com.modernmedia.corelib.widget.adapters.AbstractWheelTextAdapter;
import cn.com.modernmedia.corelib.widget.views.OnWheelChangedListener;
import cn.com.modernmedia.corelib.widget.views.OnWheelScrollListener;
import cn.com.modernmedia.corelib.widget.views.WheelView;
...
public class ChangeDistrictDialog extends Dialog implements View.OnClickListener {
    ...
    private String strCity = "自贡";
    private OnAddressCListener onAddressCListener;

    private int maxsize = 24;
    private int minsize = 14;

    public ChangeDistrictDialog(Context context) {
